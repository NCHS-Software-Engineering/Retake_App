/requests
    ...
    - Teacher can sort between stages:
        ...
        - graded   : The teacher grades the assignment, optionally can give percent grade, give feedback, or assign new assignment
...
- Where will I put the route to get teacher/student names when making a search for assigning/applying for retake
    *what should endpoint route be and how should I organize in code
