...
exports.list = async (req, res) => {
    ...
    try {
        ...
        const [rows] = await pool.query(`SELECT requestId, retakeRequests.testId, username FROM retakeRequests JOIN tests ON retakeRequests.testId = tests.testId JOIN users ON retakeRequests.userId = users.userId WHERE tests.teacherId = ?`, [teacherId]);
